...
# Config
re_path = "/ifs/scratch/as6282_gp/fy2306/projects/xrRNA_search/results/infernal/rna_2020/rna_2020.cmsearch.out"
interm_re_path = "/ifs/scratch/as6282_gp/fy2306/projects/xrRNA_search/results/infernal/rna_2020/rna_2020.cmsearch.parsed.undedup.tsv"
final_re_path = "/ifs/scratch/as6282_gp/fy2306/projects/xrRNA_search/results/infernal/rna_2020/rna_2020.cmsearch.parsed.dedup.tsv"
db_path = "/ifs/data/as6282_gp/fy2306/projects/xrRNA_search/data/ncbi_virus/ncbi_virus_All.fa.gz"
db_meta_path = "/ifs/data/as6282_gp/fy2306/projects/xrRNA_search/data/ncbi_virus/ncbi_virus_All.metadata.csv"
...
def extract_sequences(fasta_path, df):
    ...
    def fetch_sequence(row):
        ...
        try:
            ...
            return "Sequence not found"  # Or np.nan, or similar depending on needs
